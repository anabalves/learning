...
public class UserRepositoryTests {
    ...
    public void findAllPagedShouldReturnFirstPageSortedByEmail() {
        ...
        assertEquals("bob@gmail.com", list.getContent().get(1).getEmail());
        assertEquals("maria@gmail.com", list.getContent().get(2).getEmail());
    }
    ...
    public void findByEmailShouldReturnNonEmptyOptionalWhenIdExists() {
        ...
        assertEquals("Alex Brown", result.getName());
        assertEquals("alex@gmail.com", result.getEmail());
        assertEquals("[Role { id: 1, authority: ROLE_STUDENT }]", result.getRoles().toString());
    }
